...
urlpatterns = [
    ...
    path('group/<int:pk>/delete/', views.EventDelete.as_view(), name='events_delete'),
    ...
    path('<int:pk>/update', views.GroupUpdate.as_view(), name='groups_update'),
    path('<int:pk>/delete/', views.GroupDelete.as_view(), name='groups_delete'),
